...
import requests
from conversationinsights.channels.channel import UserMessage, OutputChannel
from conversationinsights.channels.rest import HttpInputComponent
...
class CustomInput(HttpInputComponent):
    ...
    frontend. You can customize this to send messages to the agent and
